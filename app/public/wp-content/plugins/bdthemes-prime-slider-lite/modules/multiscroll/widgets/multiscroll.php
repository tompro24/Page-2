...
class Multiscroll extends Widget_Base {
	...
	protected function rendar_background_image($position_bg) {
	...
	// protected function rendar_right_background_image($content) {
	// 	$settings = $this->get_settings_for_display();

	// 	$slide_image = Group_Control_Image_Size::get_attachment_image_src( $content['right_background_image']['id'], 'full', $settings);
	// 	if ( ! $slide_image ) {
	// 		$slide_image = $content['right_background_image']['url'];
	// 	}
	...
	protected function render_content_center() {
		...
		<div class="bdt-content-center">
			...
			foreach ( $settings['slides'] as $slide ) : ?>
				...
				if ( $slide['left_background_image']['id'] ) {
