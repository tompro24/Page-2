...
class Sequester extends Widget_Base {
	...
	private function register_query_section_controls() {
			...
			[
				...
				'default' => [
					[
						...
						'image' => ['url' => BDTPS_ASSETS_URL . 'images/svg-img/item-01.svg']
					],
					[
						'title' => esc_html__('Sequester Slide Two', 'bdthemes-prime-slider'),
						'image' => ['url' => BDTPS_ASSETS_URL . 'images/svg-img/item-02.svg']
					],
					[
						'title' => esc_html__('Sequester Slide Three', 'bdthemes-prime-slider'),
						'image' => ['url' => BDTPS_ASSETS_URL . 'images/svg-img/item-03.svg']
					],
				],
				'title_field' => '{{{ title }}}',
			]
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Image Match Height', 'bdthemes-prime-slider') . BDTPS_NC,
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'yes',
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Custom Overlay', 'bdthemes-prime-slider'),
				'type'    => Controls_Manager::SWITCHER,
			]
		);
		...
		$this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bdt-prime-slider .bdt-prime-slider-desc .bdt-main-title .bdt-title-tag .frist-word' => 'color: {{VALUE}}; -webkit-text-stroke-color: {{VALUE}};',
                ],
                'condition' => [
					'show_title' => ['yes'],
				],
	...
	public function render_header() {
		...
		$ratio = ($settings['slider_size_ratio']['width'] && $settings['slider_size_ratio']['height']) ? $settings['slider_size_ratio']['width'] . ":" . $settings['slider_size_ratio']['height'] : '16:8';
	...
	public function render_item_content($slide_content) {
		...
		<div class="bdt-prime-slider-content">
			<div class="bdt-prime-slider-desc">
				...
				<div class="bdt-button-wrapper" bdt-slideshow-parallax="y: 150,0,-100; opacity: 1,1,0">
